          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ListContents(
                    '6. お子様',
                    '当事務所のサービスは原則として13歳未満のお子様を対象としておらず、そうしたお子様から個人を特定できる情報を意図的に取得することはありません。何らかの事情で弊社が13歳未満のお子様からその親の同意なく個人を特定できる情報を取得してしまった場合は、その情報を弊社の記録から迅速に削除するための適切な措置を行います。'
                ),
                ListContents('7. 取得した情報の廃棄','取得した個人情報は、当事務所による通常の事業運営に照らして、合理的に不要と判断される時点で廃棄します。'),
                ListContents('8. プライバシーに関するお問い合わせ','当事務所のプライバシーポリシーに関する質問やお問い合わせは、当事務所(info@barneyz.com)にご連絡ください。ただし、アプリまたはウェブサイトに問合せ方法が定められている場合は、その記載が優先します。'),
                ListContents('9. プライバシーポリシーの変更','当事務所は、プライバシーポリシーを随時更新することがあります。プライバシーポリシーの重要な変更は、最新のプライバシーポリシーとともに当事務所のウェブサイトに掲示します。プライバシーポリシーの変更は、当事務所がウェブサイト上またはアプリ内に掲載した時点から適用されるものとします。'),
