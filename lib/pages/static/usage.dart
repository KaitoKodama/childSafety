          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                ListContents(
                    '第1条　本利用規約について',
                    'アプリ利用規約（以下「本利用規約」といいます。）は、Barneyz（以下「当事務所」といいます。）が本アプリ上で提供するサービスを、ユーザが利用する際の一切の行為に適用されます。本利用規約は、本サービスの利用条件を定めるものです。ユーザは、本利用規約に従い本サービスを利用するものとします。\n'
                ...
                ListContents(
                  '第3条 免責',
                   '当事務所は、本サービスの利用により発生したユーザの損害については、一切の賠償責任を負いません。\n'
