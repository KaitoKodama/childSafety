                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                        ...
                        child: BuildWidget().buildTextFormFieldWidget(HexColor('#1595B9'),HexColor('#1595B9'),'パスワード','',(text) => {
                          model.password = text
                        })
                    ),
                    BuildWidget().styledButton('新規登録',HexColor('#1595B9'),HexColor('#FFFFFF'),HexColor('#1595B9'),() async{
                      try {
